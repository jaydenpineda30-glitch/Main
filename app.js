...
function isLikelySeedState(d) {
  ...
  return n(d.reflections) === 0 && n(d.personal && d.personal.tasks) === 0 && n(d.personal && d.personal.archived) === 0 && n(d.gym && d.gym.exercises) === 0 && n(d.gym && d.gym.workouts) === 0 && n(d.gym && d.gym.bodyWeight) === 0 && n(d.finance && d.finance.expenses) === 0 && n(d.uni && d.uni.completedEvents) === 0 && n(d.jarvis && d.jarvis.messages) === 0 && n(d.projects) === 0 && n(d.shopping) === 0 && n(d.docs) === 0;
}
...
function ProjectsSection(_ref4) {
  ...
  var _useState137 = useState(null),
    ...
    openId = _useState138[0],
    setOpenId = _useState138[1];
  var _useState139 = useState(false),
    _useState140 = _slicedToArray(_useState139, 2),
    showImport = _useState140[0],
    setShowImport = _useState140[1];
  var _useState141 = useState(""),
    _useState142 = _slicedToArray(_useState141, 2),
    txt = _useState142[0],
    setTxt = _useState142[1];
  function toast(m, t) {
    if (window.showToast) window.showToast(m, t);
  }
  function doImport() {
...
function App() {
  var _useState147 = useState("Dashboard"),
    _useState148 = _slicedToArray(_useState147, 2),
    page = _useState148[0],
    setPage = _useState148[1];
  var _useState149 = useState(function () {
    ...
    data = _useState150[0],
    setData = _useState150[1];
  var _useState151 = useState(0),
    _useState152 = _slicedToArray(_useState151, 2),
    wkOff = _useState152[0],
    setWkOff = _useState152[1];
  var _useState153 = useState(todayStr()),
    _useState154 = _slicedToArray(_useState153, 2),
    activeDay = _useState154[0],
    setActiveDay = _useState154[1];
  var _useState155 = useState([]),
    _useState156 = _slicedToArray(_useState155, 2),
    checkinBlocks = _useState156[0],
    setCheckinBlocks = _useState156[1];
  var _useState157 = useState(false),
    _useState158 = _slicedToArray(_useState157, 2),
    checkinOpen = _useState158[0],
    setCheckinOpen = _useState158[1];
  var _useState159 = useState([{
    ...
    nxtRows = _useState160[0],
    setNxtRows = _useState160[1];
  ...
  var _useState161 = useState(""),
    ...
    bwIn = _useState162[0],
    setBwIn = _useState162[1];
  var _useState163 = useState(todayStr()),
    _useState164 = _slicedToArray(_useState163, 2),
    bwDate = _useState164[0],
    setBwDate = _useState164[1];
  var _useState165 = useState(false),
    _useState166 = _slicedToArray(_useState165, 2),
    bwEditing = _useState166[0],
    setBwEditing = _useState166[1];
  var _useState167 = useState(false),
    _useState168 = _slicedToArray(_useState167, 2),
    showCapture = _useState168[0],
    setShowCapture = _useState168[1];
  var _useState169 = useState(""),
    _useState170 = _slicedToArray(_useState169, 2),
    captureText = _useState170[0],
    setCaptureText = _useState170[1];
  var _useState171 = useState(false),
    _useState172 = _slicedToArray(_useState171, 2),
    captureLoading = _useState172[0],
    setCaptureLoading = _useState172[1];
  var _useState173 = useState(null),
    _useState174 = _slicedToArray(_useState173, 2),
    captureResult = _useState174[0],
    setCaptureResult = _useState174[1];
  var _useState175 = useState(false),
    _useState176 = _slicedToArray(_useState175, 2),
    showBoardroom = _useState176[0],
    setShowBoardroom = _useState176[1];
  var _useState177 = useState([]),
    _useState178 = _slicedToArray(_useState177, 2),
    brMessages = _useState178[0],
    setBrMessages = _useState178[1];
  var _useState179 = useState(""),
    _useState180 = _slicedToArray(_useState179, 2),
    brInput = _useState180[0],
    setBrInput = _useState180[1];
  var _useState181 = useState(false),
    _useState182 = _slicedToArray(_useState181, 2),
    brLoading = _useState182[0],
    setBrLoading = _useState182[1];
  var _useState183 = useState(null),
    _useState184 = _slicedToArray(_useState183, 2),
    brLastSpeaker = _useState184[0],
    setBrLastSpeaker = _useState184[1]; // kept for Firestore compat only
  var _useState185 = useState([]),
    _useState186 = _slicedToArray(_useState185, 2),
    brGoalProposals = _useState186[0],
    setBrGoalProposals = _useState186[1];
  var _useState187 = useState([]),
    _useState188 = _slicedToArray(_useState187, 2),
    brTaskProposals = _useState188[0],
    setBrTaskProposals = _useState188[1]; // commitments from the last session, addable as real tasks
  var _useState189 = useState(false),
    _useState190 = _slicedToArray(_useState189, 2),
    brClosing = _useState190[0],
    setBrClosing = _useState190[1];
  var _useState191 = useState(null),
    _useState192 = _slicedToArray(_useState191, 2),
    brIntentMode = _useState192[0],
    setBrIntentMode = _useState192[1]; // 'howto' | 'direction' — for header badge / loading copy
  var _useState193 = useState(null),
    _useState194 = _slicedToArray(_useState193, 2),
    brPendingIntent = _useState194[0],
    setBrPendingIntent = _useState194[1]; // {text, reconfirmed} awaiting a one-tap mode choice
  var _useState195 = useState(false),
    _useState196 = _slicedToArray(_useState195, 2),
    brShowProjCtx = _useState196[0],
    setBrShowProjCtx = _useState196[1]; // project-context panel open/closed
  var brMigrationRef = React.useRef(false);
  var _useState197 = useState([]),
    _useState198 = _slicedToArray(_useState197, 2),
    capturesData = _useState198[0],
    setCapturesData = _useState198[1];
  var _useState199 = useState(false),
    _useState200 = _slicedToArray(_useState199, 2),
    capturesLoading = _useState200[0],
    setCapturesLoading = _useState200[1];
  var _useState201 = useState("all"),
    _useState202 = _slicedToArray(_useState201, 2),
    capturesFilter = _useState202[0],
    setCapturesFilter = _useState202[1];
  var _useState203 = useState("captures"),
    _useState204 = _slicedToArray(_useState203, 2),
    journalTab = _useState204[0],
    setJournalTab = _useState204[1];
  var _useState205 = useState(""),
    _useState206 = _slicedToArray(_useState205, 2),
    capturesSearch = _useState206[0],
    setCapturesSearch = _useState206[1];
  var _useState207 = useState(null),
    _useState208 = _slicedToArray(_useState207, 2),
    expandedCapture = _useState208[0],
    setExpandedCapture = _useState208[1];
  var _useState209 = useState(null),
    _useState210 = _slicedToArray(_useState209, 2),
    expandedRefl = _useState210[0],
    setExpandedRefl = _useState210[1];
  var _useState211 = useState(null),
    _useState212 = _slicedToArray(_useState211, 2),
    editCaptureData = _useState212[0],
    setEditCaptureData = _useState212[1];
  var _useState213 = useState(""),
    _useState214 = _slicedToArray(_useState213, 2),
    editCaptureTagStr = _useState214[0],
    setEditCaptureTagStr = _useState214[1];
  var _useState215 = useState(null),
    _useState216 = _slicedToArray(_useState215, 2),
    appVersion = _useState216[0],
    setAppVersion = _useState216[1];
  var _useState217 = useState(null),
    _useState218 = _slicedToArray(_useState217, 2),
    editTaskId = _useState218[0],
    setEditTaskId = _useState218[1];
  var _useState219 = useState({}),
    _useState220 = _slicedToArray(_useState219, 2),
    editTaskForm = _useState220[0],
    setEditTaskForm = _useState220[1];
  var _useState221 = useState(false),
    _useState222 = _slicedToArray(_useState221, 2),
    gymDraftBanner = _useState222[0],
    setGymDraftBanner = _useState222[1];
  var _useState223 = useState(null),
    _useState224 = _slicedToArray(_useState223, 2),
    scheduleTaskId = _useState224[0],
    setScheduleTaskId = _useState224[1];
  var _useState225 = useState(null),
    _useState226 = _slicedToArray(_useState225, 2),
    scheduleForDay = _useState226[0],
    setScheduleForDay = _useState226[1];
  var _useState227 = useState("09:00"),
    _useState228 = _slicedToArray(_useState227, 2),
    scheduleTime = _useState228[0],
    setScheduleTime = _useState228[1];
  var _useState229 = useState(60),
    _useState230 = _slicedToArray(_useState229, 2),
    scheduleDuration = _useState230[0],
    setScheduleDuration = _useState230[1];
  var _useState231 = useState(false),
    _useState232 = _slicedToArray(_useState231, 2),
    showTimePicker = _useState232[0],
    setShowTimePicker = _useState232[1];
  var _useState233 = useState(false),
    _useState234 = _slicedToArray(_useState233, 2),
    showArch = _useState234[0],
    setShowArch = _useState234[1];
  var _useState235 = useState(0),
    _useState236 = _slicedToArray(_useState235, 2),
    reflStep = _useState236[0],
    setReflStep = _useState236[1];
  var _useState237 = useState([]),
    _useState238 = _slicedToArray(_useState237, 2),
    reflAns = _useState238[0],
    setReflAns = _useState238[1];
  var _useState239 = useState(""),
    _useState240 = _slicedToArray(_useState239, 2),
    reflIn = _useState240[0],
    setReflIn = _useState240[1];
  var _useState241 = useState(null),
    _useState242 = _slicedToArray(_useState241, 2),
    reflAnalysis = _useState242[0],
    setReflAnalysis = _useState242[1];
  var _useState243 = useState(null),
    _useState244 = _slicedToArray(_useState243, 2),
    modal = _useState244[0],
    setModal = _useState244[1];
  var _useState245 = useState({}),
    _useState246 = _slicedToArray(_useState245, 2),
    mForm = _useState246[0],
    setMForm = _useState246[1];
  var _useState247 = useState("loading"),
    _useState248 = _slicedToArray(_useState247, 2),
    syncStatus = _useState248[0],
    setSyncStatus = _useState248[1];
  var _useState249 = useState("idle"),
    _useState250 = _slicedToArray(_useState249, 2),
    obsExportStatus = _useState250[0],
    setObsExportStatus = _useState250[1]; // idle | running | done | error
  var _useState251 = useState(null),
    _useState252 = _slicedToArray(_useState251, 2),
    authUser = _useState252[0],
    setAuthUser = _useState252[1];
  var _useState253 = useState(true),
    _useState254 = _slicedToArray(_useState253, 2),
    authLoading = _useState254[0],
    setAuthLoading = _useState254[1];
  ...
  var _useState255 = useState({
    ...
    docIn = _useState256[0],
    setDocIn = _useState256[1];
  var _useState257 = useState(false),
    _useState258 = _slicedToArray(_useState257, 2),
    forceMob = _useState258[0],
    setForceMob = _useState258[1];
  var _useState259 = useState(function () {
    ...
    navCollapsed = _useState260[0],
    setNavCollapsed = _useState260[1];
  function toggleNav() {
  ...
  var _useState261 = useState(false),
    ...
    checkinLoading = _useState262[0],
    setCheckinLoading = _useState262[1];
  var _useState263 = useState(false),
    _useState264 = _slicedToArray(_useState263, 2),
    reflAnalysisLoading = _useState264[0],
    setReflAnalysisLoading = _useState264[1];
  var _useState265 = useState(false),
    _useState266 = _slicedToArray(_useState265, 2),
    showMonitor = _useState266[0],
    setShowMonitor = _useState266[1];
  var _useState267 = useState(null),
    _useState268 = _slicedToArray(_useState267, 2),
    toast = _useState268[0],
    setToast = _useState268[1]; // {msg,type:'error'|'success'|'warn'}
  var _useState269 = useState([]),
    _useState270 = _slicedToArray(_useState269, 2),
    errLog = _useState270[0],
    setErrLog = _useState270[1];
  var _useState271 = useState(false),
    _useState272 = _slicedToArray(_useState271, 2),
    showErrPanel = _useState272[0],
    setShowErrPanel = _useState272[1];
  ...
  var _useState273 = useState(function () {
    ...
    gcalEvents = _useState274[0],
    setGcalEvents = _useState274[1];
  var _useState275 = useState(false),
    _useState276 = _slicedToArray(_useState275, 2),
    gcalConnected = _useState276[0],
    setGcalConnected = _useState276[1];
  var _useState277 = useState([]),
    _useState278 = _slicedToArray(_useState277, 2),
    gcalCalendars = _useState278[0],
    setGcalCalendars = _useState278[1];
  var _useState279 = useState(function () {
    ...
    gcalSelectedIds = _useState280[0],
    setGcalSelectedIds = _useState280[1];
  var _useState281 = useState(false),
    _useState282 = _slicedToArray(_useState281, 2),
    gcalReady = _useState282[0],
    setGcalReady = _useState282[1];
  var _useState283 = useState(false),
    _useState284 = _slicedToArray(_useState283, 2),
    showCalPicker = _useState284[0],
    setShowCalPicker = _useState284[1];
  // Syllabus / assessment hub state
  var _useState285 = useState(false),
    _useState286 = _slicedToArray(_useState285, 2),
    showSyllabusImport = _useState286[0],
    setShowSyllabusImport = _useState286[1];
  var _useState287 = useState(""),
    _useState288 = _slicedToArray(_useState287, 2),
    syllabusText = _useState288[0],
    setSyllabusText = _useState288[1];
  var _useState289 = useState("2026-04-20"),
    _useState290 = _slicedToArray(_useState289, 2),
    syllabusStart = _useState290[0],
    setSyllabusStart = _useState290[1];
  var _useState291 = useState(function () {
    ...
    geminiKey = _useState292[0],
    setGeminiKey = _useState292[1];
  var _useState293 = useState(function () {
    ...
    groqKey = _useState294[0],
    setGroqKey = _useState294[1];
  var _useState295 = useState(false),
    _useState296 = _slicedToArray(_useState295, 2),
    geminiLoading = _useState296[0],
    setGeminiLoading = _useState296[1];
  var _useState297 = useState(null),
    _useState298 = _slicedToArray(_useState297, 2),
    geminiPreview = _useState298[0],
    setGeminiPreview = _useState298[1];
  var _useState299 = useState(false),
    _useState300 = _slicedToArray(_useState299, 2),
    showAddAssess = _useState300[0],
    setShowAddAssess = _useState300[1];
  var _useState301 = useState({
    ...
    addAssessForm = _useState302[0],
    setAddAssessForm = _useState302[1];
  var _useState303 = useState(function () {
      try {
    ...
    gcalExcludedIds = _useState304[0],
    setGcalExcludedIds = _useState304[1];
  ...
  var _useState305 = useState(null),
    ...
    jarvisCards = _useState306[0],
    setJarvisCards = _useState306[1];
  useEffect(function () {
  ...
  var _useState307 = useState(function () {
    ...
    morningBrief = _useState308[0],
    setMorningBrief = _useState308[1];
  useEffect(function () {
